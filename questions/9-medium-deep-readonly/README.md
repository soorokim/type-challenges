...
type CheckRecord<T> = T extends Record<RecordKey, any> ? T extends Function ? false : true : false
type DeepReadonly<T extends Record<RecordKey, any>> = {
  readonly [key in keyof T]: CheckRecord<T[key]> extends true ? DeepReadonly<T[key]> : T[key]
}
```
